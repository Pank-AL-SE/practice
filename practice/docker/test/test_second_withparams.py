...
class TestAPI: 
    @allure.story("testing_invalid_coords")
    ...
    def test_invalid_coords(self, lat, lon, res): 
        with allure.step("testing_invalid_coords"+lat+' '+lon+'\n'):      
            pytest_check.equal(functions.search_in_lat_lon(lat,lon), res)
        
        

    
    @allure.story("testing_valid_params")
    ...
    @allure.story("testing_strange_params")
